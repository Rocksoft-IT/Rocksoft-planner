...
### Phase 1: Add team_members and document the RLS gap
#### Automated
- [x] 1.1 `create table if not exists public.team_members` appears in supabase-schema.sql before its referencing foreign keys — af201e2
- [x] 1.2 `time_off` was not added as a table (documentation-only) — af201e2
- [x] 1.3 `pnpm lint` passes — af201e2
#### Manual
